...
# {V5/4} = {P5/4 Q5/4 R5/4  U5/4 V5/4 W5/4}D = {0 0 R6/5  0 0 0}D = {R5/4.z   0}D = {R5/4.z  + DE.x'^R5/4.z                         0}E = {R5/4.z + DE.(cos(9).x + sin(9).z)^R5/4.z                                                                0}E = {- DE.cos(9).R5/4.y + R5/4.z                                                                                                                0}E 
