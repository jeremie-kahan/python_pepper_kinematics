...
# {V3/2} = {P3/2 Q3/2 R3/2  U3/2 V3/2 W3/2}B = {0 0 R6/5  0 0 0}B = {R3/2.z'  0}B = {R3/2.z' + ((BC + CD).x + DE.x')^R3/2.z'        0}E = {R3/2.(cos(9).z - sin(9).x) + ((BC + CD).x + DE.(cos(9).x + sin(9).z))^R3/2.(cos(9).z - sin(9).x)        0}E = {- R3/2.sin(9).x - ((BC + CD).R3/2.cos(9) + DE.R3/2.cos²(9) + R3/2.sin²(9)) + R3/2.cos(9).z                                  0}E 
...
#        + {- R3/2.sin(9).x - ((BC + CD).R3/2.cos(9) + DE.R3/2.cos²(9) + R3/2.sin²(9)) + R3/2.cos(9).z                                  0}E
