...
# {V4/3} = {P4/3 Q4/3 R4/3  U4/3 V4/3 W4/3}C = {0 0 R6/5  0 0 0}C = {R4/3.z'  0}C = {R4/3.z' + (CD.x + DE.x')^R4/3.z'               0}E = {R4/3.(cos(9).z - sin(9).x) + (CD.x + DE.(cos(9).x + sin(9).z))^R4/3.(cos(9).z - sin(9).x)               0}E = {R4/3.(cos(9).z - sin(9).x) - CD.R4/3.cos(9).y - DE.R4/3.cos(9).y - DE.R4/3.sin(9).y                                                       0}E 
# {V3/2} = {P3/2 Q3/2 R3/2  U3/2 V3/2 W3/2}B = {0 0 R6/5  0 0 0}B = {R3/2.z'  0}B = {R3/2.z' + ((BC + CD).x + DE.x')^R3/2.z'        0}E = {R3/2.(cos(9).z - sin(9).x) + ((BC + CD).x + DE.(cos(9).x + sin(9).z))^R3/2.(cos(9).z - sin(9).x)        0}E = {R3/2.(cos(9).z - sin(9).x) -(BC + CD).R3/2.cos(9).y - DE.R3/2.cos²(9).y - R3/2.sin²(9).y                                                  0}E 
# {V2/1} = {P2/1 Q2/1 R2/1  U2/1 V2/1 W2/1}A = {0 0 R6/5  0 0 0}A = {R2/1.z'  0}A = {R2/1.z' + (AB.y + (BC + CD).x + DE.x')^R2/1.z' 0}E = {R2/1.(cos(9).z - sin(9).x) + (AB.y + (BC + CD).x + DE.(cos(9).x + sin(9).z))^R2/1.(cos(9).z - sin(9).x) 0}E = {R2/1.(cos(9).z - sin(9).x) + AB.R2/1.cos(9).x + AB.R2/1.sin(9).z - (BC + CD).R2/1.cos(9).y - DE.cos²(9).y + DE.sin²(9).z                  0}E
